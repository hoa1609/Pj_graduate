...
class CartService implements CartServiceInterface
{
    ...
    public function reCaculateCart(){
        ...
        foreach($carts as $cart){
            ...
            $cartTotalItems = $cartTotalItems + $cart->qty;
        }
        return [
            'cartTotal' => $total,
    ...
    public function remakeCart($carts){
        ...
        if(count($cartId)){
            ...
            if(isset($temp['variant'])){
                $objects['variants'] = $this->productVariantRepository->findByCondition([], true, [],['id', 'desc'], ['whereIn' => $temp['variant'], 'whereInField' => 'uuid'])->keyBy('uuid');
            }

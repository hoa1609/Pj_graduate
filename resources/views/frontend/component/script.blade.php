<script src="frontend/assets/js/vendor/jquery-3.5.1.min.js"></script>
    ...
    <script src="frontend/assets/js/plugins/nouislider.js"></script>
    ...
    <script src="frontend/assets/js/plugins/owl.carousel.min.js"></script>
    <script src="frontend/assets/js/plugins/infiniteslidev2.js"></script>
    <script src="frontend/assets/js/plugins/click-to-call.js"></script>

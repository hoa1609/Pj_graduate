                                            ...
                                            <div class="box-infor mt-4">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-lg-4 mb-2">
                                                        <input type="text" name="name" class="form-control form-select border-h-5" placeholder="chọn thành phố...">
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <input type="text" name="name" class="form-control form-select border-h-5" placeholder="chọn quận huyện...">
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <input type="text" name="name" class="form-control form-select border-h-5" placeholder="chọn phường xã...">
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-lg-12">

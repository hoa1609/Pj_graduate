...
@section('content')
    <section class="ec-page-content section-space-p">
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="card-head uk-flex uk-content-center">
                    <div class="loader">
                      <div class="truckWrapper">
                        <div class="truckBody">
                          <svg fill="none" viewBox="0 0 198 93" class="trucksvg">
                            ...
                            <rect stroke-width="3" stroke="#282828" fill="#f9f9f9" rx="2.5" height="90" width="121" y="1.5" x="6.5"></rect>
                        ...
                        <div class="truckTires">
                          ...
                          <svg fill="none" viewBox="0 0 30 30" class="tiresvg">
                            <circle stroke-width="3" stroke="#282828" fill="#282828" r="13.5" cy="15" cx="15"></circle>
                            <circle fill="#DFDFDF" r="7" cy="15" cx="15"></circle>
                          </svg>
                        </div>
                    ...
                    <div class="invoice-container mt-4">
                        ...
                        <div class="inf-pro">
                            <div class="code-item uk-flex uk-space-between">
                                <div class="code-product">Mã <span class="bg-yellow">#{{ $order->code }}</span></div>

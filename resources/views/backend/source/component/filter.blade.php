                        ...
                        <div class="text-dark p-2">
                            <div class="form-check mb-2">
                                <ul class="list-unstyled mb-0">
                                    <li class>
                                        <a href="#" class="changeStatusAll" data-value="2" data-field="publish" data-model="source" >Active toàn bộ</a>
                                    </li>
                                    <li class="mt-2">
                                        <a href="#" class="changeStatusAll" data-value="1" data-field="publish" data-model="source" >Unactive toàn bộ</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <a href="{{ route('source.create') }}" class="btn btn-md btn-danger form-control"><i class="fa fa-plus mr5"></i>Thêm Nguồn khách</a>
                </div>
            </div>
        </div>
    </div>

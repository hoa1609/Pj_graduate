        ...
        <div class="col-3">
            <div class="uk-flex">
                <div class="description pt-3">
                    <p>Bạn đang muốn xóa sản phẩm có tên là: <span class="text-danger">{{ $product->name }}</span></p>
                ...
                <div class="card-body p-0">
                    <div class="row g-0 h-100">
                        <div class="col-lg-12 border-end">
                            ...
                            <form action="{{ route('product.destroy', $product->id) }}" method="post" class="p-4 pt-3">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-12 mb-2 mb-lg-3">
                                            ...
                                            <input class="form-control" type="text" name="description"
                                                value="{{ old('name', strip_tags($product-> description ?? '')) }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12 col-12 mb-2 mb-lg-3">
                                            <label class="form-label">Hình ảnh</label> <br>
                                            <img src="{{ $product-> image ?? '' }}" alt="post" width="140px">
                                        </div>
                                    </div>
                                </div>
                                <div class="text-end">

                ...
                <div class="card-body p-0">
                    <div class="row g-0 h-100">
                        <div class="col-lg-12 border-end">
                            <h4 class="card-title fs-16 mb-0 pt-3 ps-4">Bạn đang muốn xóa thành viên có email là: {{ $postCatalogue->email }} </h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12 mb-2 mb-lg-3 ">
                                            ...
                                            <input class="form-control" type="text" name="email"
                                                value="{{ old('email', ($postCatalogue->description) ?? '') }}" readonly>
                                        </div>
                                    </div>
                                </div><!--end col-->

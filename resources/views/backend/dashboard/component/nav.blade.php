    ...
    <div class="container-xxl">
        <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                <li class="mx-3 welcome-text mt-3">
                    <h3 class="mb-0 fw-bold text-truncate">{{ $title }}</h3>
                    <h6 class="mb-1 fw-normal text-muted text-truncate fs-14">
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                <li class="dropdown">
                    <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#"
                        ...
                        @php
                            $currentLanguage = $language->firstWhere('current', 1);
                        @endphp
                        <img src="{{ $currentLanguage ? $currentLanguage->image : '' }}" alt=""
                            class="thumb-sm rounded-circle" style="object-fit: cover">
                    </a>
                    <div class="dropdown-menu">
                        @foreach ($language as $key => $val)
                            <a class="dropdown-item {{ $val->current == 1 ? 'active' : '' }}"
                                href="{{ route('language.switch', $val->id) }}"><img src="{{ $val->image }}"
                                    alt="" height="15" class="me-2">{{ $val->name }}</a>
                        @endforeach
                    </div>
                </li>
                ...
                <li class="dropdown topbar-item">
                    <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#"
                        role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="{{ Auth::user()->image ? asset(Auth::user()->image) : asset('backend/assets/images/logos/lang-logo/chatgpt.png') }}"
                            alt="User Image" class="thumb-lg rounded-circle">
                    </a>
                    <div class="dropdown-menu dropdown-menu-end py-0">
                        <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                            <div class="flex-shrink-0">
                                <img src="{{ Auth::user()->image ? asset(Auth::user()->image) : asset('backend/assets/images/logos/lang-logo/chatgpt.png') }}"
                                    alt="User Image" class="thumb-md rounded-circle" style="object-fit: cover">
                            </div>
                            <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                <h6 class="my-0 fw-medium text-dark fs-13">{{ Auth::user()->name }}</h6>
                                <small class="text-muted mb-0">{{ Auth::user()->user_catalogues->name }}</small>
                            </div>
                        </div>

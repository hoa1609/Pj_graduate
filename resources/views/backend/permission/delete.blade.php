            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">                      
                            <h4 class="card-title">Xóa phân quyền</h4>                      
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-3">
            <div class="uk-flex">
                <div class="description pt-3">
                    <p>Bạn đang muốn xóa nhóm thành viên có tên là: <span class="text-danger">{{ $permission->name }}</span></p>
                ...
                <div class="card-body p-0">
                    <div class="row g-0 h-100">
                        <div class="col-lg-12 border-end">
                            ...
                            <form action="{{ route('permission.destroy', $permission->id) }}" method="post" class="p-4 pt-3">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-12 mb-2 mb-lg-3">
                                            ...
                                            <input class="form-control" type="text" name="canonical"
                                                value="{{ old('name', ($permission-> canonical) ?? '') }}" readonly>
                                        </div>

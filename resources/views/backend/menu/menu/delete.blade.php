            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title">Xóa Menu</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-3">
            <div class="uk-flex">
                <div class="description pt-3">
                    <p>Bạn đang muốn xóa vị trí menu: <span class="text-danger">{{ $menuCatalogue->name }}</span></p>
                ...
                <div class="card-body p-0">
                    <div class="row g-0 h-100">
                        <div class="col-lg-12 border-end">
                            ...
                            <form action="{{ route('menu.destroy', $menuCatalogue->id) }}" method="post" class="p-4 pt-3">
                                @csrf
                                @method('DELETE')
                                <div class="form-group mb-2 mb-lg-1">
                                    <div class="row">
                                        <div class="col-lg-12 col-12 mb-2 mb-lg-3">
                                            <label class="form-label"> Vi trí
                                                <span class="text-danger">(*)</span>
                                            </label>
                                            <input class="form-control" type="text" name="name"
                                                value="{{ old('name', $menuCatalogue->name ?? '') }}" readonly>
                                        </div>

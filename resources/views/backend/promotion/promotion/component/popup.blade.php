    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" class="form-control search-model" placeholder="Nhập tên sản phẩm...">
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary confirm-product-promotion">Xác nhận</button>
            </div>
        </div>
    </div>
</div>

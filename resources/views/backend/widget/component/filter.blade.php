                        ...
                        <div class="text-dark p-2">
                            <div class="form-check mb-2">
                                <ul class="list-unstyled mb-0">
                                    <li class>
                                        <a href="#" class="changeStatusAll" data-value="2" data-field="publish" data-model="Widget" >Active toàn bộ</a>
                                    </li>
                                    <li class="mt-2">
                                        <a href="#" class="changeStatusAll" data-value="1" data-field="publish" data-model="Widget" >Unactive toàn bộ</a>
                                    </li>
                                </ul>
                            </div>
                        </div>

<div class="card">
    ...
    <div class="card-body pt-0">
        <div id="sortable" class="row slide-list sortui ui-sortable">
            <div class="text-danger slide-notification" {{ is_array($slides) && count($slides) > 0 ? 'hidden' : '' }}>
                Chưa có hình ảnh nào được chọn...</div>
                        ...
                        <div class="slide-item">
                            <div class="row">
                                <div class="col-4 position-relative">
                                    ...
                                    <span class="deleteSlide btn btn-danger"><i
                                            class="icofont-ui-delete menu-icon"></i></span>
                                </div>
                                <div class="col-8">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" data-bs-toggle="tab"
                                                href="#tab{{ $i }}" role="tab" aria-selected="true">Thông
                                                tin chung</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" data-bs-toggle="tab" href="#tab{{ $i + 1 }}"
                                                role="tab" aria-selected="false" tabindex="-1">SEO</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane p-2 active" id="tab{{ $i }}" role="tabpanel">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-lg-8 col-md-6 col-sm-12">
                                                    <input class="form-control" type="text" name="slide[canonical][]"
                                                        value="{{ old('slide.canonical.' . $key, $canonical) }}"
                                                        placeholder="URL">
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-check pt-1">
                                                        <input type="checkbox" name="slide[window][{{ $key }}]"
                                                            id="input_{{ $key }}" value="_blank"
                                                            {{ $window == '_blank' ? 'checked' : '' }}
                                                            class="form-check-input">
                                                        <label class="form-check-label"
                                                            for="input_{{ $key }}">Mở trong tab mới</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane p-2" id="tab{{ $i + 1 }}" role="tabpanel">
                                            <div class="form-contol mb-2">
                                                ...
                                                <input class="form-control" type="text" name="slide[name][]"
                                                    value="{{ old('slide.name.' . $key, $name) }}"
                                                    placeholder="Nhập tiêu đề">
                                            </div>
                                            <div class="form-contol mb-2">
                                                <label class="form-label">Mô tả ảnh</label>
                                                <input class="form-control" type="text" name="slide[alt][]"
                                                    value="{{ old('slide.alt.' . $key, $alt) }}"
